package com.xinling.common.utils.file;
...
import com.xinling.common.exception.file.FileNameLengthLimitExceededException;
import com.xinling.common.exception.file.FileSizeLimitExceededException;
import com.xinling.common.exception.file.InvalidExtensionException;
...
import com.xinling.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = XinLingConfig.getProfile();
    ...
    {
        int dirLastIndex = XinLingConfig.getProfile().length() + 1;
