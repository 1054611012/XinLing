package com.xinling.admin.controller.common;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = XinLingConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        try
        {
            FileRecord record = fileRecordService.uploadFile(file, "common", null);
            AjaxResult ajax = AjaxResult.success();
            ajax.put("url", record.getFileUrl());
            ajax.put("fileName", record.getFilePath());
            ajax.put("newFileName", record.getFileName());
    ...
    public AjaxResult uploadFiles(List<MultipartFile> files) throws Exception
    {
        try
        {
            ...
            {
                FileRecord record = fileRecordService.uploadFile(file, "common", null);
                urls.add(record.getFileUrl());
                fileNames.add(record.getFilePath());
                newFileNames.add(record.getFileName());
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = XinLingConfig.getProfile();
            // 数据库资源地址
